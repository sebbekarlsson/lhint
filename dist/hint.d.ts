...
export declare namespace hints {
    ...
    const union: <Of extends Array<Hint>>(of: Of) => {
        type: "union";
        of: Of;
        _hint: true;
    };
